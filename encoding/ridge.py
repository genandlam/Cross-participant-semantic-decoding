...
import numpy as np
import logging
from encoding.utils import mult_diag, counter
import random
...
def bootstrap_ridge(Rstim, Rresp, alphas, nboots, chunklen, seed = None, dtype=np.single,
    ...
    nchunks = int(np.ceil(nresp / 5 / chunklen))
